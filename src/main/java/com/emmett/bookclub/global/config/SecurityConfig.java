...
import com.emmett.bookclub.global.security.user.MemberService;
...
@ComponentScan("com.emmett.bookclub.global.security")
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/api/v1/user/**", "/api/v1/role/**").permitAll()
